...
class SettingsDialogs(private val activity: AppCompatActivity, private val apiKeyDialogs: ApiKeyDialogs) {
    fun showSettingsDialog(onModelsClick: () -> Unit, onAboutClick: () -> Unit) {
